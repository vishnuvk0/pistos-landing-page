    ...
    <section className="flex min-h-screen items-center pt-16">
      <div className="mx-auto max-w-5xl px-6 py-20 md:px-8 md:py-32">
        <div className="max-w-3xl">
          <h1 className="animate-fade-in-up text-4xl font-bold leading-tight tracking-tight text-white md:text-6xl md:leading-tight">
            {COMPANY.tagline}
          </h1>
          <p className="animate-fade-in-up-delay-1 mt-6 max-w-2xl text-lg text-text-secondary md:text-xl">
            {COMPANY.description}
          </p>
